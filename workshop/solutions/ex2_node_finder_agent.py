...
SYSTEM_PROMPT = """
You are an AI agent that is used as part of a network management software suite.
Your only job is to find nodes that within a given range of a given location.
Simply return a short list of the nodes.
"""

# Create the testing agent
node_finder_agent = Agent(
    name="NodeFinderAgent",
